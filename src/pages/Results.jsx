...
export function ResultsDashboard({ results: r, formData, unitCostDetail, depSchedule, photos = [], onBack, onStartOver }) {
  ...
  const handleShareCPA = () => {
    ...
    const body = encodeURIComponent(
      ...
      `This estimate was generated by CostSegNow using RCNLD methodology and MACRS classification standards. ` +
